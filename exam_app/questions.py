...
QUESTION_BANK: Sequence[Question] = (
    ...
    Question(
        id="basic-7",
        category=Category.COMPUTER_BASICS,
        prompt="如果希望在不同设备之间自动同步学习资料，最合适的工具是？",
        options=[
            "仅保存在U盘中",
            "使用云存储服务",
            "将文件通过电子邮件发送给自己",
        ...
        correct_option=1,
        explanation="云存储服务可以在多台设备之间同步文件并保持最新版本。",
    ),
    Question(
        id="basic-8",
        category=Category.COMPUTER_BASICS,
        prompt="为避免网络钓鱼攻击，以下做法中哪项最有效？",
        options=[
            "在任何页面都输入学号密码",
            "忽略浏览器的安全警告",
            "确认网址并启用双因素验证",
        ...
        correct_option=2,
        explanation="核对网站地址并启用双因素验证可以有效降低钓鱼攻击的风险。",
    ),
    Question(
        id="word-1",
    ...
    Question(
        id="word-7",
        category=Category.WORD,
        prompt="想要快速定位文档中的章节标题，推荐使用哪个窗格？",
        options=[
            "审阅窗格",
            "导航窗格",
            "翻译窗格",
        ...
        correct_option=1,
        explanation="导航窗格可以按标题结构快速跳转到文档各部分。",
    ),
    Question(
        id="word-8",
        category=Category.WORD,
        prompt="为保证屏幕阅读器正确识别表格，应优先设置哪项属性？",
        options=[
            "隐藏网格线",
            "合并所有单元格",
            "标记标题行",
        ...
        correct_option=2,
        explanation="标记标题行可以让阅读器在浏览表格时提供列标题信息。",
    ),
    Question(
        id="excel-1",
    ...
    Question(
        id="excel-7",
        category=Category.EXCEL,
        prompt="为了限制输入值必须位于给定范围内，应使用哪项功能？",
        options=[
            "数据验证",
            "条件格式",
            "分类汇总",
        ...
        correct_option=0,
        explanation="数据验证可以设置有效数值范围并给出提示信息。",
    ),
    Question(
        id="excel-8",
        category=Category.EXCEL,
        prompt="想要快速对连续数列求和，可使用哪个快捷键？",
        options=[
            "Alt+=",
            "Ctrl+Shift+S",
            "Alt+Tab",
        ...
        correct_option=0,
        explanation="按下Alt+=可以自动插入SUM函数并选中可能的数据区域。",
    ),
    Question(
        id="ppt-1",
    ...
    Question(
        id="ppt-7",
        category=Category.POWERPOINT,
        prompt="为了让听众理解复杂图形，可使用哪个功能添加语音说明？",
        options=[
            "录制幻灯片放映",
            "快速样式",
            "打印预览",
        ...
        correct_option=0,
        explanation="录制幻灯片放映可以为每一张幻灯片添加语音讲解。",
    ),
    Question(
        id="ppt-8",
        category=Category.POWERPOINT,
        prompt="在演示前检查屏幕阅读器朗读顺序，应打开哪个面板？",
        options=[
            "选择窗格",
            "动画窗格",
            "备注页",
        ...
        correct_option=0,
        explanation="选择窗格可以调整对象顺序，从而影响屏幕阅读器的朗读顺序。",
    ),
)
